...
// Compile time. Each build keeps one arm of every 64 bit branch and drops the
// other. A runtime flag would leave both in every hot loop
const zstdUse64Bit = bool.fromEnvironment('dart.library.isolate');

// dart2js truncates a shift to 32 bits. A left shift is a multiply here and
// the mask keeps the product exact
